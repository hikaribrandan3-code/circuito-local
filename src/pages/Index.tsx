          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 sm:gap-3 rounded-full px-4 sm:px-7 py-2.5 sm:py-3.5 text-sm sm:text-lg font-bold text-white shadow-xl hover:scale-105 active:scale-95 transition-transform whitespace-nowrap"
                style={{ background: "linear-gradient(135deg, #22c55e 0%, #16a34a 100%)" }}
              >
                <svg className="h-4 sm:h-5 w-4 sm:w-5" viewBox="0 0 24 24" fill="currentColor">
